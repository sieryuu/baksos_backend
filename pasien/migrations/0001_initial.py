# Generated by Django 3.2.10 on 2022-09-08 14:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('puskemas', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='referensi.puskesmas')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddIndex(
            model_name='pasien',
            index=models.Index(fields=['nama', 'tanggal_lahir'], name='pasien_pasi_nama_4ad925_idx'),
        ),
    ]
